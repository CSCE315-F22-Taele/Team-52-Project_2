...
public class MenuOptions {
    ...
    private HashMap<Product.Name, JButton> drinkButtonMap;
...
// DO NOT EDIT OR ADD ANY CODE HERE!
            ...
            entry.getValue().addItemListener(new ItemListener() {
                ...
                public void itemStateChanged(ItemEvent event) {
                    ...
                    if (pizzaToppingNames.contains(entry.getKey().toString())) {
                        // count the number of pizza menuitem products that are ingredients (including this new one)
    ...
    public MenuOptions() {
        ...
        drinkButtonMap = new HashMap<Product.Name, JButton>() {{
