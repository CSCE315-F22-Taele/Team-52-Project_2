...
public class Migration {
    ...
    public void populate() throws SQLException {
        String[] productNames = {"Fountain Cup", "Bottle Beverage", "Gatorade", "Cauliflower", "Standard", "Alfredo", "Traditional Red", "Zesty Red", "House Blend", "Parmesan", "BBQ Sauce", "Olive Oil", "Oregano", "Ranch", "Sriracha", "Diced Ham", "Italian Sausage", "Meatball", "Pepperoni", "Salami", "Smoked Chicken", "Banana Peppers", "Black Olives", "Green Peppers", "Jalapenos", "Mushrooms", "Onions", "Pineapple", "Roasted Garlic", "Spinach", "Tomatoes"};

        String[] menuItems = {"1 Topping Pizza", "2-4 Topping Pizza", "Original Cheese Pizza", "Bottle Beverage", "Gatorade", "Fountain Cup"};

        String[] menuItemPrices = {"7.79", "8.99", "6.79", "2.39", "2.39", "1.99",};
        ...
        for (String productName : productNames) {
            ...
            Product p = Product.create(database, productName, qty);
            products.add(p);
        }
        ...
        for (int i = 0; i <= 2; ++i) {
            ...
            for (Product product : products) {
                ...
                double qty = (new BigDecimal(500 + (200 * Math.random()))).round(new MathContext(2, RoundingMode.CEILING)).doubleValue();
